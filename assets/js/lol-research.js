...
if(window.location.href.includes("https://cedricbeausseron.github.io/myElo")) {//github
    api_key = "RGAPI-69b41414-f409-49e0-8512-4ba421a3c6e9";//a changer : correspond à celle ttes les 24h
}else if(window.location.href.includes("https://myelo.herokuapp.com/")){//heroku
    api_key = "RGAPI-f30b5d4d-9697-4ab3-bd3b-e1c7d5e607af";  
}else{//local, change toutes les 24h
    api_key = "RGAPI-69b41414-f409-49e0-8512-4ba421a3c6e9";  
}
...
//     let response = await fetch('https://euw1.api.riotgames.com/lol/summoner/v4/summoners/by-name/'+pseudo+'?api_key='+api_key)
...
// //     try{
// //         const response = await fetch('https://euw1.api.riotgames.com/lol/summoner/v4/summoners/by-name/'+pseudo+'?api_key='+api_key)
// //         .then((response) => {
